...
* [Mappa dei contesti di ARchetipo](architecture/context-map.md) - Confini runtime osservabili e dipendenze tra skill, CLI, connector, provider, viewer e distribuzione. _State: reviewed._
...
* [Template di processo del workspace](decisions/workspace-process-template.md) - Il processo di un workspace è un valore builtin nominato, risolto per ID all'inizializzazione e conservato nella configurazione. _State: reviewed._

## Engineering

* [Mappa del codice di ARchetipo](engineering/code-map.md) - Corrispondenza fisica tra responsabilita osservabili, entry point, integrazioni, test e boundary ispezionati. _State: reviewed._
