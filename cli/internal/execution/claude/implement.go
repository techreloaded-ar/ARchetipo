...
// session.
//
// It is a single turn, like planning and unlike inception: the agent is not
// talking to anybody, so a turn that ends without a receipt has failed rather
// than asked a question, and that must be said now instead of waiting for an
